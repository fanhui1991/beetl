...
K.options = {
	...
	zIndex : 811213,
	items : [
		'source','undo', 'redo', 'cut', 'copy', 'plainpaste','=','multiimage','|','removeformat', 'bold','justifyleft', 'justifycenter', 'justifyright',
		'justifyfull', 'insertorderedlist', 'insertunorderedlist', 'quickformat', 'selectall', '|', 'fullscreen'
	],
