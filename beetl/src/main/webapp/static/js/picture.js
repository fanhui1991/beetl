...
function calcPicHover() {
    $(".indexbody-right").mousemove(function() {
        $(this).css("cursor", "url(./static/images/xice/next.cur), auto");
        $(this).attr("title", "浏览下一张 支持键盘右→翻页")
    });
    $(".indexbody-left").mousemove(function() {
        $(this).css("cursor", "url(./static/images/xice/pre.cur),auto");
...
var controlPicture = {
    ...
    changePic: function(f, a, c) {
        ...
        if (picList) {
            ...
            $("#showOriginal").attr("href", picList[h - 1].bigPic);
    ...
    checkAndLoadImg: function(e, d, c, a) {
        var b = new Image();
        b.src = e;
        var f = c ? "../images/xice/grey1.gif": "../images/xice/loading2.gif";
        if (b.complete) {
            $(d).css("display", "none");
            d.src = e;
            $(d).fadeIn("normal");
